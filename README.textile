h2. This is a fork of https://github.com/robbyrussell/oh-my-zsh.git
...
@curl -L https://github.com/z7z8th/oh-my-zsh/raw/master/tools/install.sh | sh@

h4. via `wget`

@wget --no-check-certificate https://github.com/z7z8th/oh-my-zsh/raw/master/tools/install.sh -O - | sh@
...
1. Clone the repository
  ...
  @git clone git://github.com/z7z8th/oh-my-zsh.git ~/.oh-my-zsh@
